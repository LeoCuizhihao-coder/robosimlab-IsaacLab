...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    top_view_camera = CameraCfg(
        ...
        # offset=CameraCfg.OffsetCfg(pos=(0.5, 0.0, 1.8), rot=(0.707, 0.0, 0.0, 0.707), convention="usd"),
        offset=CameraCfg.OffsetCfg(pos=(1.1, 0.0, 1.0), rot=(0.68301, 0.18301, 0.18301, 0.68301), convention="usd"),
    )
    ...
    eye_in_hand_camera = CameraCfg(
        ...
        # offset=CameraCfg.OffsetCfg(pos=(0.02, 0.00, -0.02), rot=(0.707, 0.0, 0.0, 0.707), convention="usd"),
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        robot_eef_pos = ObsTerm(func=mdp.robot_eef_pos)
        robot_eef_quat = ObsTerm(func=mdp.robot_eef_quat)
